      ...
      <div className="flex flex-col lg:flex-row lg:space-x-24 pb-16">
          ...
          >
            <g>
              <Link
                ...
                onClick={() =>
                  handleMouseClick(focusedRegion) as unknown as MouseEventHandler<HTMLAnchorElement>
                }
              >
        ...
        <div className="lg:w-4/12 lg:flex lg:pt-44 text-dark lg:order-3 sm:hidden">
          <ul className="text-center p-4 sm:p-0">
            ...
            >
              <Link to="/region/ARA">Auvergne-Rhône-Alpes</Link>
            </li>
            <li
              className={
                focusedRegion === "BFC"
            ...
            >
              <Link to="/region/BFC">Bourgogne-Franche-Comté</Link>
            </li>
            <li
              className={
                focusedRegion === "BRE"
            ...
            >
              <Link to="/region/BRE">Bretagne</Link>
            </li>
            <li
              className={
                focusedRegion === "CVL"
            ...
            >
              <Link to="/region/CVL">Centre-Val-de-Loire</Link>
            </li>
            <li
              className={
                focusedRegion === "COR"
            ...
            >
              <Link to="/region/GES">Grand-Est</Link>
            </li>
            <li
              className={
                focusedRegion === "GUA"
            ...
            >
              <Link to="/region/region/GUA">Guadeloupe</Link>
            </li>
            <li
              className={
                focusedRegion === "GUY"
            ...
            >
              <Link to="/region/GUY">Guyane</Link>
            </li>
            <li
              className={
                focusedRegion === "HDF"
            ...
            >
              <Link to="/region/HDF">Hauts-de-France</Link>
            </li>
            <li
              className={
                focusedRegion === "IDF"
            ...
            >
              <Link to="/region/IDF">Île-de-France</Link>
            </li>
            <li
              className={
                focusedRegion === "MAR"
            ...
            >
              <Link to="/region/MAR">Martinique</Link>
            </li>
            <li
              className={
                focusedRegion === "MAY"
            ...
            >
              <Link to="/region/MAY">Mayotte</Link>
            </li>
            <li
              className={
                focusedRegion === "NOR"
            ...
            >
              <Link to="/region/NOR">Normandie</Link>
            </li>
            <li
              className={
                focusedRegion === "NAQ"
            ...
            >
              <Link to="/region/NAQ">Nouvelle-Aquitaine</Link>
            </li>
            <li
              className={
                focusedRegion === "OCC"
            ...
            >
              <Link to="/region/OCC">Occitanie</Link>
            </li>
            <li
              className={
                focusedRegion === "PDL"
            ...
            >
              <Link to="/region/PDL">Pays-De-La-Loire</Link>
            </li>
            <li
              className={
                focusedRegion === "PAC"
            ...
            >
              <Link to="/region/PAC">Provence-Alpes-Côte d'Azur</Link>
            </li>
            <li
              className={
                focusedRegion === "REU"
            ...
            >
              <Link to="/region/REU">Réunion</Link>
            </li>
          </ul>
        </div>
      </div>
